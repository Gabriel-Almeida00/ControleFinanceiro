...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Categoria", b =>
                {
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Funcao", b =>
                {
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Ganho", b =>
                {
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Mes", b =>
                {
                    b.Property<int>("MesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Tipo", b =>
                {
                    b.Property<int>("TipoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Usuario", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Categoria", b =>
                {
                    b.HasOne("ControlerFinanceiro.BLL.Models.Tipo", "Tipo")
                        .WithMany("Categorias")
            ...
            modelBuilder.Entity("ControlerFinanceiro.BLL.Models.Despesa", b =>
                {
                    ...
                    b.HasOne("ControlerFinanceiro.BLL.Models.Mes", "Mes")
                        .WithMany("Despesas")
                        .HasForeignKey("MesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ControlerFinanceiro.BLL.Models.Funcao", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ControlerFinanceiro.BLL.Models.Usuario", null)
                        .WithMany()
